...
function MovieCard({ movie }: { movie: Movie }) {
    return (
        <Link href={`/movieDetails/${movie.original_title}?genre_id=${movie.id}`} className='relative flex-shrink-0 cursor-pointer tranform  hover:scale-105 transition duration-200 ease-out hover:drop-shadow-lg'>
